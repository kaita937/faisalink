...
<body>
    ...
    <header class="header-section">
        <div class="logo-icon">
            <img src="<?php echo e(asset('Icon/logo.png')); ?>" alt="Logo Faisalink">
        </div>
        ...
        <div class="text-container">
            ...
            <div class="btn-wrapper">
                <a href="<?php echo e(route('login')); ?>" class="btn-start">Get Started / Login</a>
            </div>
        </div>
    </header>
    ...
    <main class="illustration-section">
        <img src="<?php echo e(asset('Icon/building.png')); ?>" alt="Ilustrasi Gedung" class="illustration-image" onerror="this.src='https://via.placeholder.com/1200x500/E8E8E8/808080?text=Silakan+tambahkan+gambar+potongan+ilustrasi+gedung+di+sini+nanti'">
    </main>

</body>
</html>
<?php /**PATH C:\Users\Windows\Downloads\faisalink\resources\views/landing.blade.php ENDPATH**/ ?>