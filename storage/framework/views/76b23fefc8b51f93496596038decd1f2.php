...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-top: 20px;">
                <a href="<?php echo e(route('landing')); ?>" style="color: #2e66ff; text-decoration: none; font-size: 0.9rem;">Back to Home</a>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\Windows\Downloads\faisalink\resources\views/login.blade.php ENDPATH**/ ?>